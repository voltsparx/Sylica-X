...
CONNECTOR_REGISTRY: tuple[ConnectorSpec, ...] = (
    ConnectorSpec(
        ...
        binary_candidates=("sherlock", "sherlock.py"),
        source_entrypoints=("intel-sources/sherlock/sherlock_project/__main__.py",),
    ),
    ConnectorSpec(
        connector_id="identity_mesh_beta",
        title="Identity Mesh Beta",
        scopes=("profile", "fusion"),
        binary_candidates=("maigret",),
        source_entrypoints=("intel-sources/maigret/maigret/__main__.py",),
    ),
    ConnectorSpec(
        connector_id="surface_grid_alpha",
        title="Surface Grid Alpha",
        scopes=("surface", "fusion"),
        binary_candidates=("amass",),
    ),
    ConnectorSpec(
    ...
    ConnectorSpec(
        ...
        source_entrypoints=("intel-sources/spiderfoot/sf.py", "intel-sources/spiderfoot/sfscan.py"),
    ...
    ConnectorSpec(
        ...
        scopes=("profile", "surface", "fusion"),
        binary_candidates=("recon-ng", "recon-cli"),
        source_entrypoints=("intel-sources/recon-ng/recon-ng", "intel-sources/recon-ng/recon-cli"),
        supports_execution=False,
    ),
    ConnectorSpec(
        ...
        scopes=("profile", "surface", "fusion"),
        source_entrypoints=("intel-sources/datasploit/datasploit.py",),
        supports_execution=False,
    ),
)
