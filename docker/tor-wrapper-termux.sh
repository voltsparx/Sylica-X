...
TOR_CONFIG="${SCRIPT_DIR}/torrc.silica"
TOR_DATA_DIR="${TOR_DATA_DIR:-${PREFIX:-$HOME}/var/lib/tor-data}"
NO_INSTALL=0
TOR_ARGS=()
...
Wrapper options:
  ...
  --data-dir <path>    Tor data dir (default: \$PREFIX/var/lib/tor-data).
